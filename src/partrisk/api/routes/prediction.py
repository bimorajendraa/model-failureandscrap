...
Route sengaja tipis: seluruh keputusan ada di partrisk/serving/predictor.py.
...
from partrisk.api.schemas import AssessmentResponse, FailureResponse, HistoryResponse, ScrapResponse
from partrisk.serving import predictor
from partrisk.serving.errors import PartNotScorable
